...
// get one car photo
router.get(`/cars/car_photo/:filename`, getCarPhotoAsBase64)

// Read one record
router.get(`/cars/get_car/:id`, verifyUsersJWTPassword, getCarDocument)

// Add new record
router.post(`/cars/add_car`, verifyUsersJWTPassword, checkThatUserIsAnAdministrator, upload.array("carPhotos", parseInt(process.env.MAX_NUMBER_OF_UPLOAD_FILES_ALLOWED)), createNewCarDocument)

// Update one record
router.put(`/cars/update_car/:id`, verifyUsersJWTPassword, updateCarDocument)

// Delete one record
router.delete(`/cars/delete_car/:id`, verifyUsersJWTPassword, checkThatUserIsAnAdministrator, deleteCarDocument)
